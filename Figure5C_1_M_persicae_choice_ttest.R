...
mp.c$genotype <- factor(mp.c$genotype, levels=c("cyp87a126-1", "cyp87a126-2"))

#### Paired t-test (for each genotype separately)
t2b16 <- t.test(mp.c[mp.c$genotype=="cyp87a126-1", "n_WT"], mp.c[mp.c$genotype=="cyp87a126-1", "n_mut"], paired = TRUE, alternative = "two.sided")
t2b16
# 2b16 p-value: 0.12
t2e1 <- t.test(mp.c[mp.c$genotype=="cyp87a126-2", "n_WT"], mp.c[mp.c$genotype=="cyp87a126-2", "n_mut"], paired = TRUE, alternative = "two.sided")
t2e1
# 2e1 p-value = 0.08